document.addEventListener('DOMContentLoaded', function () {
  ...
  const animatedElements = document.querySelectorAll(
    '.fade-in, .animate-on-scroll, [data-animate], .section-title, .feature-card, .testimonial-card, .pricing-card, .team-card, .hero-content, .about-content, .service-item, .portfolio-item, .blog-card, .cta-section, .stat-item, .icon-box'
  );
    ...
    "translations": {
      "en": {
        "consentModal": {
          ...
          "description": "Ivana's Alchemy uses cookies to enhance your experience, analyze site usage, and assist in our marketing efforts. You can manage your preferences anytime.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'c8602a28-637e-4192-b691-da130b1abcf6',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'c8602a28-637e-4192-b691-da130b1abcf6';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'c8602a28-637e-4192-b691-da130b1abcf6';
